...
import com.techbuzzer.login.dao.ItemDeleteClass;
...
public class DeleteProductCon extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("delete_item") != null) {
            ...
            ItemDeleteClass del = new ItemDeleteClass();
            boolean delItems;
            delItems = del.deleteItem(id);

            if (delItems) {
                String message = "Deleted " + product_name + " successfully";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DeleteProductCon.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
