    ...
    <body>
        <nav class="navbar navbar-expand-lg fixed-top navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand fonted1 navbarItem" href="home.jsp">THE TECHBUZZER</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link fonted2 navbarItem" href="login.jsp">STAFF PORTAL<span class="sr-only">(current)</span></a>
                    </ul>
                </div>
            </div>
        </nav>
